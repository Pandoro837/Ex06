...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("javaStudy", "onCreate: 액티비티1");
    ...
    protected void onStart() {
        super.onStart();
        Log.d("javaStudy", "onStart: 액티비티1");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.d("javaStudy", "onResume: 액티비티1");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.d("javaStudy", "onPause: 액티비티1");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.d("javaStudy", "onDestroy: 액티비티1");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.d("javaStudy", "onRestart: 액티비티1");
    }
}